<template>
  <div class='publish-container'>
   <el-card>
     <div class="header"><my-breadcrumb>编辑文章</my-breadcrumb></div>
     <br>
...
import { modArticle, getArticle } from '../../api/article.js'
  ...
  methods: {
    ...
    hSaveArticle (isDraft) {
      ...
      this.$refs.form.validate(async (valid) => {
        ...
        if (valid) {
          try {
            const result = await modArticle(this.article.id, this.article)
            console.log(result)
